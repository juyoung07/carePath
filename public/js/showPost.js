// 초기 데이터
let showPostInfo = [
    { "id": "1", "userName": "해피바이러스", "content": "다들 힘내시길 바랍니다! 배주연 상담사님이 상담이 정말 잘 해주시니까 참고하셨음 좋겠어요!" },
    { "id": "2", "userName": "코코넛 바다", "content": "다들 화이팅입니다! 바우처 도움 되는거 진짜 많으니까 꼭 찾아보세요" },
    { "id": "3", "userName": "안녕하세요", "content": "취업 성공했습니다. 다들 기 받아가세요." },
    { "id": "4", "userName": "밝은 햅쌀", "content": "매일 조금씩 나아가면 결국 원하는 곳에 도달할 거예요. 응원하고 있어요, 힘내세요(아자아자!!)" },
    { "id": "5", "userName": "햇살같은미소", "content": "언제나 당신의 옆에 사람들이 있어요. 혼자가 아니니까, 힘들 땐 주저하지 말고 함께 조금만 더 버텨요!!." },
    { "id": "6", "userName": "따뜻한별빛", "content": "지금은 너무 힘들어도, 조금만 더 기다리면 분명히 밝은 날이 올 거예요." },
